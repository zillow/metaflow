...
##
# TODO: https://zbrt.atl.zillow.net/browse/AIP-7385 WFSDK: Rename KFP plugin to AIP
...
KFP_MAX_RUN_CONCURRENCY = int(from_conf("KFP_MAX_RUN_CONCURRENCY", 10))
KFP_ARGO_COMPILE_WORKFLOW_ONLY = bool(
    from_conf("KFP_ARGO_COMPILE_WORKFLOW_ONLY", False)
)
